package com.unef.domain.business.associated.type.renderer
{
	...
	public class AssociatedTypeGridRenderer extends DatagridOperationsRendererTemplate implements DatagridItemRenderer
	{
		public function AssociatedTypeGridRenderer()
		{
			super();
		}		
