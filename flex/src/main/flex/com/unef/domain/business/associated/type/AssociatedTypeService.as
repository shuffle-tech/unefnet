package com.unef.domain.business.associated.type
{
	...
	public class AssociatedTypeService extends BaseService implements IService
	{
		
		private static const SERVICE_NAME:String = "AssociatedTypeService";
		
		public function AssociatedTypeService(target:IEventDispatcher=null)
		{
			super(target);
		}
