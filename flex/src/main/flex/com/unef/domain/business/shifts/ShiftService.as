package com.unef.domain.business.shifts
{
	...
	public class ShiftService extends BaseService implements IService
	{
		
		private static const SERVICE_NAME:String = "ShiftService";
		
		public function ShiftService(target:IEventDispatcher=null)
		{
			super(target);
		}
