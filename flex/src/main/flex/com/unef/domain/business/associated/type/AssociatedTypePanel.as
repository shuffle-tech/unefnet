package com.unef.domain.business.associated.type
{
	...
	public class AssociatedTypePanel extends AssociatedTypePanelTemplate implements IView
	{
		private var _controller:AssociatedTypeController;
		...
		public function get controller():AssociatedTypeController{
			if (null  == _controller){
				_controller = new AssociatedTypeController(this);				
			}
			return _controller;
		} 
