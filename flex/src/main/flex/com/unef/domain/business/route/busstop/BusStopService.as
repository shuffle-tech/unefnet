package com.unef.domain.business.route.busstop
{
	...
	public class BusStopService extends BaseService implements IService
	{
		public static const SERVICE_NAME:String = "BusStopService";												
				
		
		public function BusStopService(target:IEventDispatcher=null)
		{
			super(target);
		}
