package com.unef.domain.business.institutions.renderer
{
	...
	public class InstitutionGridRenderer extends DatagridOperationsRendererTemplate implements DatagridItemRenderer
	{
		public function InstitutionGridRenderer()
		{
			super();
		}		
