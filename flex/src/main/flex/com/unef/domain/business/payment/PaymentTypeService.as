package com.unef.domain.business.payment
{
	...
	public class PaymentTypeService extends BaseService implements IService
	{
		
		private static const SERVICE_NAME:String = "PaymentTypeService";
		
		public function PaymentTypeService(target:IEventDispatcher=null)
		{
			super(target);
		}
