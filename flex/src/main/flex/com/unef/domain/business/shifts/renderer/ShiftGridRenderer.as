package com.unef.domain.business.shifts.renderer
{
	...
	public class ShiftGridRenderer extends DatagridOperationsRendererTemplate implements DatagridItemRenderer
	{
		public function ShiftGridRenderer()
		{
			super();
		}		
