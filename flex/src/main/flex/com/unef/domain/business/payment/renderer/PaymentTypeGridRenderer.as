package com.unef.domain.business.payment.renderer
{
	...
	public class PaymentTypeGridRenderer extends DatagridOperationsRendererTemplate implements DatagridItemRenderer
	{
		public function PaymentTypeGridRenderer()
		{
			super();
		}		
