package com.unef.domain.business.payment
{
	...
	public class PaymentTypePanel extends PaymentTypePanelTemplate implements IView
	{
		
		private var _controller:PaymentTypeController;
		
		public function PaymentTypePanel()
		{
			super();
		}
		...
		public function get controller():PaymentTypeController{
			if (null  == _controller){
				_controller = new PaymentTypeController(this);				
			}
			return _controller;
		} 
		...
		protected function add(event:MouseEvent):void{
			template.stack.selectedChild = template.addPaymentType;
		}
	}
}